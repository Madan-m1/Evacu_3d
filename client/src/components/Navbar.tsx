    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-[#0f1117]/90 backdrop-blur-md border-b border-gray-800/60">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 h-14 flex items-center justify-between gap-4">
        ...
        <Link to="/" className="flex items-center gap-2.5 shrink-0 group">
          <div className="p-1.5 bg-gradient-to-br from-red-500/20 to-orange-500/10 rounded-lg border border-red-500/30 group-hover:border-red-400/50 transition-colors">
            <ShieldAlert size={18} className="text-red-400" />
          </div>
          <span className="font-extrabold text-white text-lg tracking-tight" style={{ fontFamily: "'Inter', sans-serif" }}>Evacu<span className="bg-gradient-to-r from-red-400 to-orange-400 bg-clip-text text-transparent">3D</span></span>
        </Link>
